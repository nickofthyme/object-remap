...
exports.getMappedValues = exports.trimByDepth = exports.getAllInputs = exports.getCaseFunction = exports.parseValue = void 0;
const core_1 = __importDefault(__nccwpck_require__(186));
const change_case_1 = __nccwpck_require__(91);
const lodash_get_1 = __importDefault(__nccwpck_require__(197));
const lodash_set_1 = __importDefault(__nccwpck_require__(552));
...
const caseMap = {
    snake: (s) => s
        .split('.')
        .map((p) => (p === '*' ? p : change_case_1.snakeCase(p)))
        .join('.'),
    camel: (s) => s
        .split('.')
        .map((p) => (p === '*' ? p : change_case_1.camelCase(p)))
        .join('.'),
    pascal: (s) => s
        .split('.')
        .map((p) => (p === '*' ? p : change_case_1.pascalCase(p)))
        .join('.'),
    lower: (s) => s.toLowerCase(),
    upper: (s) => s.toUpperCase(),
};
const getCaseFunction = (stringCase = 'snake') => {
    return caseMap[stringCase];
};
exports.getCaseFunction = getCaseFunction;
function getAllInputs() {
    var _a, _b;
    const casingFunction = exports.getCaseFunction(process.env.INPUT___CASE);
    core_1.default.info(`CASe ----> ${(_a = process.env.INPUT___CASE) !== null && _a !== void 0 ? _a : ''}`);
    return ((_b = Object.entries(process.env)) !== null && _b !== void 0 ? _b : []).reduce((result, [key, value]) => {
        ...
        core_1.default.info(`CASSING ----> before: ${key} after: ${inputName}`);
        try {
            // All values are stringified so try to parse typed value
            result[inputName] = JSON.parse(value);
        }
        catch (_a) {
...
function trimByDepth(object, depth) {
    if (!depth)
        return object;
        ...
        if (Array.isArray(value)) {
            if (depth === 1)
                ...
                for (const o of value)
                    trimByDepth(o, depth - 1); // arrays indices don't count on depth
        }
        else if (typeof value === 'object' && typeof value !== null) {
            if (depth === 1)
                delete object[key];
            else
                trimByDepth(object[key], depth - 1);
        }
    }
    return object;
}
...
function getMappedValues() {
    const _a = getAllInputs(), { __depth } = _a, inputs = __rest(_a, ["__depth"]);
    const newMappings = {};
    Object.freeze(newMappings.__proto__);
    let count = Object.keys(inputs).length;
    core_1.default.info('--------- Inputs ---------');
    for (const inputPath in inputs) {
        count--;
        if (inputs.hasOwnProperty(inputPath)) {
            const re = /(.+?)\.\*\.(.+)/;
            const value = inputs[inputPath];
            const truncValue = typeof value === 'string' && value.length > 200
                ? `${value.slice(0, 200)}...`
                : value;
            core_1.default.info(`path: ${inputPath}`);
            core_1.default.info(`type: ${typeof value}`);
            core_1.default.info(`value: ${truncValue}`);
            ...
            if (re.test(inputPath)) {
                ...
                for (const [index, element_] of parsedValue.entries()) {
                    ...
                    lodash_set_1.default(element, second, element_);
                    newCurrent[index] = element;
                }
                lodash_set_1.default(newMappings, first, newCurrent);
            }
            else {
                lodash_set_1.default(newMappings, inputPath, parsedValue);
            }
            if (count)
                core_1.default.info('--------------------------');
        }
...
function run() {
    try {
        ...
        core_1.default.info('--------- Output ---------');
        core_1.default.info('Remapped json:');
        core_1.default.info(JSON.stringify(newMappings, null, 2));
        core_1.default.setOutput('json', json);
    }
    catch (error) {
...
var tslib_1 = __nccwpck_require__(646);
...
var tslib_1 = __nccwpck_require__(145);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var tslib_1 = __nccwpck_require__(220);
tslib_1.__exportStar(__nccwpck_require__(638), exports);
tslib_1.__exportStar(__nccwpck_require__(824), exports);
tslib_1.__exportStar(__nccwpck_require__(878), exports);
tslib_1.__exportStar(__nccwpck_require__(246), exports);
tslib_1.__exportStar(__nccwpck_require__(657), exports);
tslib_1.__exportStar(__nccwpck_require__(397), exports);
tslib_1.__exportStar(__nccwpck_require__(452), exports);
tslib_1.__exportStar(__nccwpck_require__(995), exports);
tslib_1.__exportStar(__nccwpck_require__(553), exports);
...
var tslib_1 = __nccwpck_require__(728);
var no_case_1 = __nccwpck_require__(397);
...
var tslib_1 = __nccwpck_require__(627);
var no_case_1 = __nccwpck_require__(397);
...
var tslib_1 = __nccwpck_require__(288);
var capital_case_1 = __nccwpck_require__(824);
...
var tslib_1 = __nccwpck_require__(472);
...
var tslib_1 = __nccwpck_require__(769);
var no_case_1 = __nccwpck_require__(397);
...
var tslib_1 = __nccwpck_require__(595);
var dot_case_1 = __nccwpck_require__(246);
...
var tslib_1 = __nccwpck_require__(166);
var no_case_1 = __nccwpck_require__(397);
var upper_case_first_1 = __nccwpck_require__(256);
...
var tslib_1 = __nccwpck_require__(46);
var dot_case_1 = __nccwpck_require__(246);
